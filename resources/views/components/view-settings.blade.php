...
{{--
    ...
    Two shapes for two places — same split as <x-lang-switch>. In the top row
    it is a disclosure (the row is already full). Inside the mobile drawer it
    is an inline panel: a second nested dropdown over an open drawer would
    hide the same choice twice.
--}}
...
@php
    ...
    // The "A" is a sample of the step; chip labels stay short (Max / Макс /
    // Maks) so the three columns stay the same height.
    $sizes = [
